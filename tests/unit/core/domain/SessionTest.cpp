...
namespace {
    const std::vector<QString> source_StringsReturnAutomatic{
            "automatic",
            "Automatic"};

    const std::vector<QString> source_StringsReturnManual{
            "manual",
            "Manual"};

    const std::vector<QString> status_StringsReturnActive{
            "active",
            "Active"};

    const std::vector<QString> status_StringsReturnCompleted{
            "completed",
            "Completed"};

    const std::vector<QString> status_StringsReturnInterrupted{
            "interrupted",
            "Interrupted"};
} // namespace
